...
import {userPermissions, createRole, editRole, updateRole, roleDelete} from '../../config.json';
...
function RoleListing() {
  ...
  const changeStatus = async (roleId, isActive) => {
    ...
    return (
      <>
        <div className="flex justify-end mt-3">
          {currentUser.rolePermission.includes(createRole)
          ?
          <Link to="add-role">
                      ...
                      return (
                        <tr key={id}>
                          ...
                          <td className={className}>
                            ...
                            /> */}
                            {currentUser.rolePermission.includes(updateRole)
                            ?
                            <Button 
                            variant="gradient"
                            color={is_active ? "green" : "red"}
                          ...
                          <td className={className}>
                            ...
                            >
                              {currentUser.rolePermission.includes(editRole)
                              ?
                              ...
                              : ""}
                              {currentUser.rolePermission.includes(roleDelete)
                              ?
                              <IconButton
                                  variant="text"
                                  color="red"
